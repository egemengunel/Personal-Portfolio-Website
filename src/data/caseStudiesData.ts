...
export const caseStudies: CaseStudy[] = [
  {
    ...
    designSystem: {
      ...
      typeScale: [
        ...
        {
          label: 'Heading 3',
          sample: 'It pollinates flowers and eats mosquitoes.',
          size: '1.5rem',
          weight: 600,
          maps: 'custom, 24pt',
        },
        {
          label: 'Heading 4',
          sample: 'Search for a region or a place.',
          size: '1.375rem',
          weight: 700,
          maps: '.title2',
        },
        ...
        {
          label: 'Heading 6',
          sample: 'Ask anything about this species',
          size: '1.375rem',
          weight: 400,
          maps: '.title2',
        },
        {
          label: 'Heading 7',
          sample: 'Not sure about this one',
          size: '1.25rem',
          weight: 400,
          maps: '.title3',
        },
        ...
        {
          label: 'Body 5',
          sample: 'Active species near you',
          size: '0.8125rem',
          weight: 600,
          maps: '.footnote',
        },
        {
          label: 'Body 6',
          sample: 'One bug, not the whole leaf.',
          size: '0.75rem',
          weight: 500,
          maps: '.caption',
        },
        ...
        {
          label: 'Body 8',
          sample: 'May be incorrect. Not medical advice.',
          size: '0.6875rem',
          weight: 400,
          maps: '.caption2',
        },
  ...
  },
  {
    ...
    designSystem: {
      ...
      typeScale: [
        { label: 'Heading 1', sample: 'Collections', size: '2.125rem', weight: 700, maps: '.largeTitle' },
        { label: 'Heading 2', sample: 'Say hello to Lucid.', size: '1.75rem', weight: 700, maps: '.title' },
        { label: 'Heading 3', sample: 'What are your goals?', size: '1.75rem', weight: 400, maps: '.title' },
        { label: 'Heading 4', sample: 'Name your flashcards', size: '1.375rem', weight: 700, maps: '.title2' },
        { label: 'Heading 5', sample: 'Select a collection', size: '1.25rem', weight: 600, maps: '.title3' },
        { label: 'Heading 6', sample: 'Your subjects', size: '1.25rem', weight: 400, maps: '.title3' },
        { label: 'Body 1', sample: 'Talk with your notes', size: '1.0625rem', weight: 600, maps: '.body' },
        { label: 'Body 2', sample: 'Lucid will adapt to your study style.', size: '1.0625rem', weight: 400, maps: '.body' },
        { label: 'Body 3', sample: 'Prepare for exams', size: '1rem', weight: 600, maps: '.callout' },
        { label: 'Body 4', sample: 'Organize your materials into folders.', size: '1rem', weight: 400, maps: '.callout' },
        { label: 'Body 5', sample: 'Review concepts with customized cards.', size: '0.9375rem', weight: 600, maps: '.subheadline' },
        { label: 'Body 6', sample: 'By continuing, you agree to our terms.', size: '0.8125rem', weight: 600, maps: '.footnote' },
      ],
    },
    sections: [
      {
  ...
  },
  {
    ...
    designSystem: {
      ...
      note: "Three accents, four score bands, and a mesh gradient built out of the accents themselves. These are the values from the shipped asset catalog, not the ones I drew. The type is the part that dates it: every size is a fixed point value in a custom font file, so none of it answers Dynamic Type. Lucid and Antenna are both built on the platform\u2019s text styles instead.",
      palette: [
      ...
      typeScale: [
        { label: 'Heading 1', sample: '83', size: '4rem', weight: 700, tracking: '-0.02em', maps: 'fixed, 64pt' },
        { label: 'Heading 2', sample: 'Record', size: '4rem', weight: 400, tracking: '-0.02em', maps: 'fixed, 64pt' },
        { label: 'Heading 3', sample: 'Four Things You Should Know', size: '1.375rem', weight: 700, maps: 'fixed, 22pt' },
        { label: 'Heading 4', sample: 'Lung Score', size: '1.25rem', weight: 600, maps: 'fixed, 20pt' },
        { label: 'Heading 5', sample: 'Excellent Score', size: '1.0625rem', weight: 600, maps: 'fixed, 17pt' },
        { label: 'Body', sample: 'Find a quiet environment with minimal background noise', size: '1.0625rem', weight: 400, maps: 'fixed, 17pt' },
      ],
    },
    sections: [
      {
